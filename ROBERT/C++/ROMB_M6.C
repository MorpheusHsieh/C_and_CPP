...
//#define myfunc 0.5*q(y*sqrt(aaa*Eb_N0)*cos(x))*rician_pdf(2,y)*theta_pdf(6.9897*Eb_N0,x)
  ...
  #define myfunc 0.5*q(y*sqrt(aaa*Eb_N0))*rician_pdf(kk,y)
  #define yy1_x   0
  #define yy2_x   3
  #define X_1  0
  #define X_2  1
...
void main()
{
 ...
 if ((out0 = fopen("d:\\trash\\co50.dat", "a+t")) == NULL)
 {
   fprintf(stderr, "Cannot open input file.\n");
   return 1;
 }
 if ((out1 = fopen("d:\\trash\\co51.dat", "a+t")) == NULL)
 {
   fprintf(stderr, "Cannot open input file.\n");
   return 1;
 }
